...
-- Keymapping
RegisterKeyMapping("IncreaseRadarRange", "ProLaser: Augmenter distance", "keyboard", "right")
RegisterKeyMapping("DecreaseRadarRange", "ProLaser: Réduire distance", "keyboard", "left")
RegisterKeyMapping("AimRadarGun", "ProLaser: Viser", "keyboard", "Q")
