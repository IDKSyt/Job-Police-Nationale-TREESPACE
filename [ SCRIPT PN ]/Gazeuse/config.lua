...
Config = {
    ...
    RechargeCoords = { -- Coordinated to recharge the pepper spray and decontamination spray
        vector3(457.86, -102.62, 27.49), --Police Nationale
        vector3(374.68, -1599.39, 29.29), -- Police Municipale
        vector3(-1634.19, -1026.35, 13.15), -- Police Municipale annexe
        vector3(-452.54, 6012.95, 31.76), -- Gendarmerie Chamonix
        vector3(1852.23, 3697.72, 34.26), -- Gendarmerie Annecy
        vector3(2529.75, -335.95, 101.89), -- Douane
        vector3(-62.58, -2511.96, 7.39), -- Douane Port
    },
...
Config.Keys = {
    SplitKey = 306, -- Key to spit
    SplitKeyString = '~INPUT_REPLAY_ENDPOINT~', -- Key string to spit

    RubbingKey = 104, -- Key to rub the eyes
    RubbingKeyString = '~INPUT_VEH_SHUFFLE~', -- Key string to rub the eyes

    ReplaceKey = 46, -- Key to replace your pepper spray
    ReplaceKeyString = '~INPUT_TALK~' -- Key string to replace your pepper spray
}
