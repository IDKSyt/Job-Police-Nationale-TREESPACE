...
RegisterCommand('props', function()
    if ESX.PlayerData.job and ESX.PlayerData.job.name == 'police' or ESX.PlayerData.job.name == 'gendarme' or ESX.PlayerData.job.name == 'pompier' or ESX.PlayerData.job.name == 'ambulance' then
